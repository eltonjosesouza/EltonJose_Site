...
export const SunIcon = ({ className, ...rest }) => (
  ...
  >
    {/* ... (mantendo conteúdo SVG do SunIcon) ... */}
...
export const MoonIcon = ({ className, ...rest }) => (
  <svg
    ...
    className={cx("w-full h-auto", className)}
  >
    {/* ... (mantendo conteúdo SVG do MoonIcon) ... */}
    <g
      fill="none"
      stroke="currentColor"
      strokeLinecap="round"
...
export const LinkedinIcon = ({ className, ...rest }) => {
  return <Linkedin className={cx("w-full h-auto", className)} {...rest} />;
};
...
export const GithubIcon = ({ className, ...rest }) => {
  return <Github className={cx("w-full h-auto", className)} {...rest} />;
};

export const DribbbleIcon = ({ className, ...rest }) => {
  return <Dribbble className={cx("w-full h-auto", className)} {...rest} />;
};

export const InstagramIcon = ({ className, ...rest }) => {
  return <Instagram className={cx("w-full h-auto", className)} {...rest} />;
};
