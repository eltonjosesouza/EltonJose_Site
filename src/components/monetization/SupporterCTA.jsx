...
const SupporterCTA = () => {
  ...
  return (
    <div className="p-6 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 my-8 text-center shadow-sm">
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="flex flex-wrap justify-center gap-3 w-full">
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-5 py-2 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-dark dark:text-light font-bold rounded-lg transition-colors flex items-center gap-2"
            >
                🔗 Perfil LivePix
            </a>
        </div>
